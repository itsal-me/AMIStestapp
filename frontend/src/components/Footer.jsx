                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                    ...
                    <div className="space-y-4">
                        ...
                        <p className="text-light-700 text-sm">
                            Connecting farmers and traders for a better
                            agricultural future. Your trusted platform for
                            agricultural trade.
                        </p>
                    </div>
                    ...
                    {/* Quick Links */}
                    <div>
                        <h3 className="text-sm font-semibold text-light-900 uppercase tracking-wider mb-4">
                            Quick Links
                        </h3>
                        <ul className="space-y-3 text-light-600">
                            <li>
                                <a
                                    href="/market-prices"
                ...
                <div className="mt-12 pt-8 border-t border-light-200">
                    <div className="flex flex-col md:flex-row justify-between items-center">
                        <div className="text-light-700 text-sm">
                            © {new Date().getFullYear()} AgriConnect. All rights
                            reserved.
                        </div>
